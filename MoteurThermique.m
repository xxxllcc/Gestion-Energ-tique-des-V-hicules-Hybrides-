...
% Définition des tableaux absisses & ordonnées des cartographies
% Régime : (rad/s), speed range of the engine
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Consommation spécifique et émissions spécifiques
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fc_ralenti_spq=800*pi/300; % Régime de ralenti
...
fc_cspe_min=min(min(fc_fuel_map_gpkWh)); % g/kWh consommation spécifique minimale
% Données annexes
